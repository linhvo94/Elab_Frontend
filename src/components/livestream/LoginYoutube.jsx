...
export default class LoginYoutube extends React.Component {
    ...
    makeVideoUploadRequest = async () => {
        ...
        invocation.open('POST', "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet%2Cstatus", true);
        invocation.setRequestHeader('Authorization', 'Bearer ' + window.gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token);
        // invocation.setRequestHeader('Content-Type', 'application/json');
        invocation.onload = () => {
            console.log(invocation.response.id); // Retrieve uploaded file ID.
        };
