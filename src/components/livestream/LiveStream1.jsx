                        ...
                        success: () => {
                            ...
                            this.janus.attach({
                                ...
                                success: (pluginHandle) => {
                                    ...
                                    // });
                                    let publisherConfig = { request: "join", ptype: "publisher", room: 456, id: 1, display: `Linh Vo` };
                                    this.sfu.send({ message: publisherConfig });
        ...
        Janus.init({
            ...
            callback: () => {
                if (!Janus.isWebrtcSupported) {
                    ...
                    this.janus = new Janus({
                        server: this.janusServer,
                        // iceServers: [{ urls: "stun:e-lab.host:5349" },
                        // { urls: "turn:e-lab.host:5349?transport=udp", username: "lcq", credential: "lcq" },
                        // { urls: "turn:e-lab.host:5349?transport=tcp", username: "lcq", credential: "lcq" }],
                        success: () => {
                            console.log("=== success connect ===");
                            let remoteFeed = null;
                            this.janus.attach({
                                ...
                                success: (pluginHandle) => {
                                    ...
                                    let subscriberConfig = { request: "join", ptype: "subscriber", room: 456, feed: 1 };
                                    ...
                                    remoteFeed.videoCodec = "vp8".toUpperCase();
